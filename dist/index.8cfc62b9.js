...
},{"./scripts/app":"dVfCV"}],"dVfCV":[function(require,module,exports) {
    ...
    on() {
        ...
        $buttons.forEach(($button)=>{
            $button.addEventListener("click", (e)=>{
                ...
                else if ($button.textContent === "\u2BA8") (0, _utils.back)($input);
                else if ($button.textContent === "x\xb2") (0, _utils.sqrt)($input);
                else if ($button.textContent === "\xf7" || $button.textContent === "*" || $button.textContent === "+" || $button.textContent === "-") (0, _utils.base)(state, $input, $button);
                else if ($button.textContent === "=") (0, _utils.calcBase)(state, $input);
...
},{"./utils":"5Zwrt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5Zwrt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function base(state, $input, $button) {
...
},{}]},["hIFAM","6rimH"], "6rimH", "parcelRequire5f40")
